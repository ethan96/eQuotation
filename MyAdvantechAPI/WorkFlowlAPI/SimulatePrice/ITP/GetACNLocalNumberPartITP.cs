...
namespace WorkFlowlAPI.SimulatePrice
{
    ...
    public sealed class GetACNLocalNumberPartITP : CodeActivity
    {
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            try
            {
                Advantech.Myadvantech.Business.QuoteBusinessLogic.GetACNLocalNumberPartITP(quoteDetails, ERPId);
