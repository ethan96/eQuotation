...
namespace WorkFlowlAPI.ACNGPApproval {
    
    
    [System.Runtime.InteropServices.ComVisible(false)]
    public partial class ACNFindApproverFlow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        ...
        private System.Activities.InArgument<System.Collections.Generic.List<Advantech.Myadvantech.DataAccess.QuotationDetail>> _EWQuotationdetails;
...
partial void AfterInitializeComponent();
        ...
        public System.Activities.InArgument<System.Collections.Generic.List<Advantech.Myadvantech.DataAccess.QuotationDetail>> EWQuotationdetails {
            get {
                return this._EWQuotationdetails;
            }
            set {
                this._EWQuotationdetails = value;
            }
        }
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(ACNFindApproverFlow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(ACNFindApproverFlow));
        ...
        private string FindResource() {
            string[] resources = typeof(ACNFindApproverFlow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".ACNFindApproverFlow.g.xaml") || resource.Equals("ACNFindApproverFlow.g.xaml"))) {
                    return resource;
                }
            }
