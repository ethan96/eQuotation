...
namespace WorkFlowlAPI.ACNGPApproval {
    ...
    public partial class ACNApprovalFlow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        ...
        private System.Activities.OutArgument<WorkFlowlAPI.ApprovalResult> _Result;
...
partial void AfterInitializeComponent();
        ...
        public System.Activities.OutArgument<WorkFlowlAPI.ApprovalResult> Result {
            get {
                return this._Result;
            }
            set {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(ACNApprovalFlow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(ACNApprovalFlow));
        ...
        private string FindResource() {
            string[] resources = typeof(ACNApprovalFlow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".ACNApprovalFlow.g.xaml") || resource.Equals("ACNApprovalFlow.g.xaml"))) {
                    return resource;
                }
            }
