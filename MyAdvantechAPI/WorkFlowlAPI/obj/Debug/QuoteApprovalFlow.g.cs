...
namespace WorkFlowlAPI {
    ...
    public partial class QuoteApprovalFlow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(QuoteApprovalFlow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(QuoteApprovalFlow));
        ...
        private string FindResource() {
            string[] resources = typeof(QuoteApprovalFlow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".QuoteApprovalFlow.g.xaml") || resource.Equals("QuoteApprovalFlow.g.xaml"))) {
                    return resource;
                }
            }
