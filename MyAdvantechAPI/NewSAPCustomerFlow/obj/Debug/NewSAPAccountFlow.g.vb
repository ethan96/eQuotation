...
Partial Public Class Activity1
    ...
    Private _RequestedBy As System.Activities.InArgument(Of String)
    
    Private _CustomerId As System.Activities.InArgument(Of String)
    
    Private _SiebelAccountId As System.Activities.InArgument(Of String)
    
    Private _currApplicationId As System.Activities.InArgument(Of String)
...
End Sub
    ...
    Public Property RequestedBy() As System.Activities.InArgument(Of String)
        Get
    ...
    Public Property CustomerId() As System.Activities.InArgument(Of String)
        Get
    ...
    Public Property SiebelAccountId() As System.Activities.InArgument(Of String)
        Get
            Return Me._SiebelAccountId
        End Get
        Set
            Me._SiebelAccountId = value
        End Set
    End Property
    
    Public Property currApplicationId() As System.Activities.InArgument(Of String)
        Get
            Return Me._currApplicationId
        End Get
        Set
            Me._currApplicationId = value
        End Set
    End Property
    ...
    Private Function FindResource() As String
        ...
        Do While (i < resources.Length)
            ...
            If (resource.Contains(".NewSAPAccountFlow.g.xaml") OrElse resource.Equals("NewSAPAccountFlow.g.xaml")) Then
                Return resource
            End If
            i = (i + 1)
        Loop
