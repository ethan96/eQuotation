<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AEUQuoteTemplateTesting.aspx.vb" Inherits="EDOC.AEUQuoteTemplateTesting" %>
...
<body>
    ...
    <h1>AEU Quotation Template Testing Page</h1> 
        ...
        <ContentTemplate>--%>
            <table width="600px" id="view_type_option" runat="server" border="1">
                <tr>
                    ...
                    <td width="300">
                        <asp:TextBox ID="TextBoxQID" runat="server">518b620688e840a</asp:TextBox>
                    </td>
                    <td width="100">
