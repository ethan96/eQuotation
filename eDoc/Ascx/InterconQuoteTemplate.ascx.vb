Public Class InterconQuoteTemplate
    ...
    Public Sub LoadData()
        ...
        If Not IsNothing(QuoteHeaderLine) Then
            ...
            'Ryan 20160202 Get Bank Account by currency.
            Account.Text = Advantech.Myadvantech.Business.QuoteBusinessLogic.GetBankAccountByCurrency(QuoteHeaderLine.org, QuoteHeaderLine.currency)

            If QuoteHeaderLine.org.Equals("TW20") Then
                Me.lbBeneficiary.Text = "ADVANTECH SERVICE-IOT CO., LTD. TAIWAN BRANCH"
            End If
    ...
    Protected Sub FillQuoteInfo(ByRef QuoteMasterRow As IBUS.iDocHeaderLine, ByRef QuoteDetailTb As IBUS.iCartList)
        ...
        If QuoteDetailTb IsNot Nothing AndAlso QuoteDetailTb.Count > 0 Then
            ...
            With QuoteMasterRow
                ...
                LbSalesEmailatTop.Text = .CreatedBy

                lblSalesPerson.Text = "Sales Representative: " & SAPDAL.SAPDAL.GetSalesRepresentativeByEmployeeID(String.Empty, .CreatedBy)
                lblSalesPerson.Text &= " Email: <A Href='mailto:" & .CreatedBy & "'>" & .CreatedBy & "</A>"
    ...
    Protected Sub gv1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        If e.Row.RowType = DataControlRowType.Header OrElse e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If Not IsNothing(hRow) Then
                ...
                'Frank 20150702
                If _pri_format <> EnumSetting.USPrintOutFormat.CP_Format Then
                ...
                If e.Row.RowType = DataControlRowType.DataRow Then
                    ...
                    If Not IsBtoParentItem AndAlso part_no.ToLower.StartsWith("ags-") = False AndAlso Business.isInvalidPhaseOutV2(part_no, ORG, strStatusCode, strStatusDesc, 0, False) Then
                        'Frank 20170707:Sabrina confirmed that just change the description's color to red, no need to display part's status in SAP
                        'CType(e.Row.FindControl("lbdescription"), Label).Text = "(Phase Out)"
                        'CType(e.Row.FindControl("lbdescription"), Label).Text = strStatusCode & "(" & strStatusDesc & ")"
