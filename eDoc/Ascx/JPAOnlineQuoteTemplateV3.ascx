<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="JPAOnlineQuoteTemplateV3.ascx.vb"
    Inherits="EDOC.JPAOnlineQuoteTemplateV3" %>
<div>
    <style type="text/css">
        .w25p {
            width: 25%;
                                ...
                                <table id="JPtable2" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse;"
                                    ...
                                    <tr>
                                        ...
                                        <td class="style_while_backcolor" rowspan="2" style="text-align: left; padding-left: 5px;">
                                            <input runat="server" id="btospatno" value="<%# CType(Container.DataItem, IBUS.iCartLine).VirtualPartNo.Value%>" class="styleReadOnly" style="width:99%"/>
                                        </td>
        ...
        <tr runat="server" id="trLooseItems" visible="false">
            <td align="center" colspan="2" style="width: 100%">
                <asp:GridView ID="gvLooseItems" runat="server" AllowPaging="false" EmptyDataText="no Item." AutoGenerateColumns="false"
                    ...
                    <Columns>
                        <asp:TemplateField ItemStyle-HorizontalAlign="left" HeaderText="No" HeaderStyle-Width="5%">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="製品型番" HeaderStyle-Width="15%" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:Label ID="lbLooseItemPartNo" runat="server" Text='<%#Eval("partNo") %>' ReadOnly="true"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="製品説明" HeaderStyle-Width="43%">
                            <ItemTemplate>
                                <asp:Label ID="lbLooseItemDesc" runat="server" Text='<%#Eval("part_Desc") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="数量" HeaderStyle-Width="5%" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:Label ID="lbLooseItemQty" runat="server" Text='<%#Eval("QTY") %>' ReadOnly="true"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="単価（税抜）" HeaderStyle-Width="15%" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:Label ID="lbLooseItemUnitPrice" runat="server" Text='<%#Eval("newunitPrice") %>' ReadOnly="true"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="見積合計（税抜）" HeaderStyle-Width="17%" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="830">
                                    ...
                                    <tr>
                                        <td class="style9" height="21">
                                            <input readonly="readonly" value="シティバンク、エヌ・エイ銀行（0401）本店（730）　普通口座7329383　アドバンテック(株)" class="styleReadOnly2" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="style9" height="21">
